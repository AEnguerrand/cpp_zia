...
TEST(HttpParser, Request) {
  ...
  zia::api::Net::Raw request = transform::StringToRaw(
      "GET /index.html HTTP/1.1 \r\nUser-Agent: Mozilla/4.0 (compatible; "
      "MSIE5.01; Windows NT) \r\nHost: "
      "www.tutorialspoint.com\r\nAccept-Language: en-us\r\nAccept-Encoding: "
      "gzip, deflate\r\nConnection: Keep-Alive");
  zia::api::Net::Raw responseSample =
      transform::StringToRaw("HTTP/1.1 200 OK\r\n\
  ...
  zia::api::Net::Raw responseRaw =
      parser.ResponseToRaw(response, zia::api::http::Method::get);
  std::string responseStr = transform::RawToString(responseRaw);

  ASSERT_STREQ(
      responseStr.c_str(),
      "HTTP/1.1 200 OK\r\nCache - Control: no - cache, no - store, must - "
      "revalidate, max - age = 0, proxy - revalidate, no - transform, "
      "private\r\nConnection: close\r\nContent - Type: text / xml\r\nDate: "
      "Wed, 13 May 2009 16 : 26 : 47 GMT\r\nETag: "
      "\"4A0AF4C7-08E1-37C7F492\"\r\nExpires: Tue, 12 May 2009 16 : 26 : 47 "
      "GMT\r\nLast - Modified: Thu, 14 May 2009 16 : 26 : 47 GMT\r\nP3P: "
      "policyref = \"/w3c/p3p.xml\", CP = \"NOI DSP COR NID PSA OUR IND COM "
      "NAV STA\"\r\nPragma: no - cache\r\nVary: *\r\nX - C: ms - "
      "3.7.2\r\nxserver: www79\r\n\r\n< ? xml version = \"1.0\" encoding = "
      "\"UTF-8\" ? > <status>SUCCESS< / status>");
}
...
TEST(HttpParser, HttpParserException) {
  nz::HttpParserException e(
      "Test construction for the HttpParserException class");
