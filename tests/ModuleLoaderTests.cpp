...
TEST(ModuleLoader, ModuleLoader) {
  std::vector<std::string> names = {
      "cpp_zia_module_router", "cpp_zia_module_php", "cpp_zia_module_router",
      "cpp_zia_module_network"};
  ...
  nz::DLLoader<zia::api::Module> const &dlLoaderConst =
      moduleLoaderConst.getDlLoader();
