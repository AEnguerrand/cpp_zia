 ...
 * Dynamic library implementing it must export a "create" C function returning a
 * "Net*" (caller should use smart pointers).
 */
class Net {
public:
  /**
  ...
  /**
   * Launch the server asynchronously, callback will be called when a request is
   * received. \return true on success, otherwise false
   */
